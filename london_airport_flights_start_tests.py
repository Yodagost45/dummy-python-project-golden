...
def test_start_returns_result_of_collect_flight_per_airport():
    fake_result = {"Heathrow": "BA100", "Gatwick": "EZ200"}
...
def test_start_calls_fetch_airports_with_module_constants():
...
def test_start_returns_empty_dict_when_no_airports_found():
    with patch("london_airport_flights.fetch_airports_by_search", return_value={}), \
         patch("london_airport_flights.extract_airports", return_value=[]), \
         patch("london_airport_flights.collect_flight_per_airport", return_value={}):
        result = start()
...
def test_start_returns_dict_type():
    with patch("london_airport_flights.fetch_airports_by_search", return_value={}), \
         patch("london_airport_flights.extract_airports", return_value=[]), \
         patch("london_airport_flights.collect_flight_per_airport", return_value={}):
        result = start()
